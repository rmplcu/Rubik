...
public class Cubo {
    ...
    //Post-condizioni: ruota la faccia di colore c verso destra
    public void ruota(char c) {
        switch (c) {
            case 'w':
                ruotaBianco();
                break;
    ...
    public void ruotaDx(char c) {
        ruota(c);
        System.out.println(c);
        System.out.println(toString());
    }

    //Post-condizioni: ruota la faccia di colore c verso sinistra
    public void ruotaSx(char c) {
        for (int i=0; i<3; i++) {
            ruota(c);
        }
        System.out.println(c);
